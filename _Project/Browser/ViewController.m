            ...
            else // Handle Press in the Browser view
            {
                ...
                if ([fieldType isEqualToString:@"date"] || [fieldType isEqualToString:@"datetime"] || [fieldType isEqualToString:@"datetime-local"] || [fieldType isEqualToString:@"email"] || [fieldType isEqualToString:@"month"] || [fieldType isEqualToString:@"number"] || [fieldType isEqualToString:@"password"] || [fieldType isEqualToString:@"search"] || [fieldType isEqualToString:@"tel"] || [fieldType isEqualToString:@"text"] || [fieldType isEqualToString:@"time"] || [fieldType isEqualToString:@"url"] || [fieldType isEqualToString:@"week"]) {
                    ...
                    UIAlertAction *inputAction = [UIAlertAction
                                                  ...
                                                  {
                        UITextField *inputViewTextField = alertController.textFields[0];
                        NSString *inputValue = inputViewTextField.text;
                        ...
                        for (NSUInteger i = 0; i < inputValue.length; i++) {
                            unichar character = [inputValue characterAtIndex:i];
                            NSString *charString = [NSString stringWithFormat:@"%C", character];
                            
                            [javaScript appendFormat:@"nativeInputValueSetter.call(textField, textField.value + '%@');"
                             "textField.dispatchEvent(new KeyboardEvent('keydown', {key: '%@', bubbles: true}));"
                             "textField.dispatchEvent(new KeyboardEvent('keypress', {key: '%@', bubbles: true}));"
                             "textField.dispatchEvent(new KeyboardEvent('keyup', {key: '%@', bubbles: true}));"
                             "textField.dispatchEvent(new Event('input', { bubbles: true}));"
                             , charString, charString, charString, charString];
                        }
                        
                        [javaScript appendFormat:@"textField.dispatchEvent(new Event('blur'));"
